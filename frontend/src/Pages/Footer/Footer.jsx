...
// import TV from "../../components/Images/TV App Logo.png";
        ...
        <div id="devices-info_container">
          <div className="devices-info">
            <div className="tv-logo">
              <img
                src={require("../../components/Images/TV App Logo.png")}
                alt=""
              />
            </div>
            ...
            <div className="devices">
              <div className="device">
                <img
                  src={require("../../components/Images/product_landing 1.png")}
                  alt=""
                />
              ...
              <div className="device">
                <img
                  src={require("../../components/Images/product_landing 2.png")}
                  alt=""
                />
              ...
              <div className="device">
                <img
                  src={require("../../components/Images/product_landing 3.png")}
                  alt=""
                />
              ...
              <div className="device">
                <img
                  src={require("../../components/Images/product_landing 4.png")}
                  alt=""
                />
              ...
              <div className="device">
                <img
                  src={require("../../components/Images/product_landing 5.png")}
                  alt=""
                />
